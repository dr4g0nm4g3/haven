/*
 * stdio.h - header for standard input/output functions
 *
 * date: 04/28/2007
...
#define _HCLIB_STDIO_H _HCLIB_STDIO_H
...
/* used by setvbuf */
#define _IOFBF 1			/* I/O is fully buffered */
#define _IOLBF	2 			/* I/O is line buffered */
#define _IONBF	4			/* I/O is not buffered */

/* The following are platform-dependant, and defined in _PDCLIB_config.h. */
typedef _HCLIB_fpos_t        fpos_t;			/* type suitable for storing any position in a file */
typedef struct _HCLIB_file_t FILE;				/* type suitable for storing information for a file stream */
#define EOF -1									/* negative integer which indicates an end-of-file */
#define BUFSIZE _HCLIB_BUFSIZ
#define FOPEN_MAX _HCLIB_FOPEN_MAX				/* integer representing the max # of files that a system can guarantee to be opened simultaneously */
#define FILENAME_MAX _HCLIB_FILENAME_MAX		/* integer representing the longest length of a char array to hold the longest possible filename */
#define L_tmpnam _HCLIB_L_tmpnam				/* integer representing the longest length of a char array to hold the longest possible temporary filename created by the tmpnam function */
#define TMP_MAX _HCLIB_TMP_MAX					/* max # of unique filenames that the function tmpnam can generate */

/* used in the fseek function */
#define SEEK_CUR 1			/* seek from current position */
#define SEEK_END 2			/* seek from end of the file */
#define SEEK_SET 4			/* seek from beginning of the file */

/* unsigned integer result of sizeof keyword */
...
extern struct _HCLIB_file_t * stderr;		/* standard error */
extern struct _HCLIB_file_t * stdin;		/* standard input */
extern struct _HCLIB_file_t * stdout;		/* standard output */
...
*/
struct _HCLIB_file_t * tmpfile( void );
...
*/
FILE * freopen( const char * _HCLIB_restrict filename, const char * _HCLIB_restrict mode, struct _HCLIB_file_t * _HCLIB_restrict stream );
...
*/
void setbuf( struct _HCLIB_file_t * _HCLIB_restrict stream, char * _HCLIB_restrict buf );
...
*/
int setvbuf( struct _HCLIB_file_t * _HCLIB_restrict stream, char * _HCLIB_restrict buf, int mode, size_t size );
...
/*
   ...
   otherwise.
*/
int fprintf( struct _HCLIB_file_t * _HCLIB_restrict stream, const char * _HCLIB_restrict format, ... );
...
/*
   ...
   first conversion.
*/
int fscanf( struct _HCLIB_file_t * _HCLIB_restrict stream, const char * _HCLIB_restrict format, ... );

/* Equivalent to fprintf( stdout, format, ... ). */
int printf( const char * _HCLIB_restrict format, ... );

/* Equivalent to fscanf( stdin, format, ... ). */
int scanf( const char * _HCLIB_restrict format, ... );
...
*/
int snprintf( char * _HCLIB_restrict s, size_t n, const char * _HCLIB_restrict format, ... );

/* Equivalent to fprintf( stdout, format, ... ), except that the result is
   written into the buffer pointed to by s, instead of stdout.
*/
int sprintf( char * _HCLIB_restrict s, const char * _HCLIB_restrict format, ... );
...
/* Equivalent to fprintf( stream, format, ... ), except that the argument stack
   ...
   <stdio.h>.
*/
int vfprintf( struct _HCLIB_file_t * _HCLIB_restrict stream, const char * _HCLIB_restrict format, _HCLIB_va_list arg );

/* Equivalent to fscanf( stream, format, ... ), except that the argument stack
   is passed as va_list parameter. Note that va_list is not declared by
   <stdio.h>.
*/
int vfscanf( struct _HCLIB_file_t * _HCLIB_restrict stream, const char * _HCLIB_restrict format, _HCLIB_va_list arg );

/* Equivalent to fprintf( stdout, format, ... ), except that the argument stack
   is passed as va_list parameter. Note that va_list is not declared by
   <stdio.h>.
*/
int vprintf( const char * _HCLIB_restrict format, _HCLIB_va_list arg );
...
/* Equivalent to snprintf( s, n, format, ... ), except that the argument stack
   ...
   <stdio.h>.
   */
int vsnprintf( char * _HCLIB_restrict s, size_t n, const char * _HCLIB_restrict format, _HCLIB_va_list arg );
...
/* Equivalent to fprintf( stdout, format, ... ), except that the argument stack
   ...
   <stdio.h>.
*/
int vsprintf( char * _HCLIB_restrict s, const char * _HCLIB_restrict format, _HCLIB_va_list arg );
...
/* Equivalent to fscanf( stdin, format, ... ), except that the argument stack
   ...
   <stdio.h>.
*/
int vsscanf( const char * _HCLIB_restrict s, const char * _HCLIB_restrict format, _HCLIB_va_list arg );
...
*/
int fgetc( struct _HCLIB_file_t * stream );
...
*/
int fputc( int c, struct _HCLIB_file_t * stream );
...
*/
int ungetc( int c, struct _HCLIB_file_t * stream );
...
*/
int fgetpos( struct _HCLIB_file_t * _HCLIB_restrict stream, fpos_t * _HCLIB_restrict pos );
...
*/
int fsetpos( struct _HCLIB_file_t * stream, const fpos_t * pos );
...
void clearerr( struct _HCLIB_file_t * stream );
...
/*
     Include wide-character I/O if wchar.h was included.
 */
#ifdef _HCLIB_WCHAR_H
