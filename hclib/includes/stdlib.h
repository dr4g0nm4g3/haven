...
#ifndef _HCLIB_STDLIB_H
#define _HCLIB_STDLIB_H _HCLIB_STDLIB_H
...
double strtod( const char * _HCLIB_restrict nptr, char * * _HCLIB_restrict endptr );
float strtof( const char * _HCLIB_restrict nptr, char * * _HCLIB_restrict endptr );
long double strtold( const char * _HCLIB_restrict nptr, char * * _HCLIB_restrict endptr );
...
*/
long int strtol( const char * _HCLIB_restrict nptr, char * * _HCLIB_restrict endptr, int base );
long long int strtoll( const char * _HCLIB_restrict nptr, char * * _HCLIB_restrict endptr, int base );
unsigned long int strtoul( const char * _HCLIB_restrict nptr, char * * _HCLIB_restrict endptr, int base );
unsigned long long int strtoull( const char * _HCLIB_restrict nptr, char * * _HCLIB_restrict endptr, int base );
...
extern unsigned long int _HCLIB_seed;
...
*/
#define EXIT_SUCCESS _HCLIB_SUCCESS
#define EXIT_FAILURE _HCLIB_FAILURE
...
*/
typedef struct _HCLIB_div_t     div_t;
typedef struct _HCLIB_ldiv_t   ldiv_t;
typedef struct _HCLIB_lldiv_t lldiv_t;
...
int mbtowc( wchar_t * _HCLIB_restrict pwc, const char * _HCLIB_restrict s, size_t n );
int wctomb( char * s, wchar_t wc );
size_t mbstowcs( wchar_t * _HCLIB_restrict pwcs, const char * _HCLIB_restrict s, size_t n );
size_t wcstombs( char * _HCLIB_restrict s, const wchar_t * _HCLIB_restrict pwcs, size_t n );
*/
