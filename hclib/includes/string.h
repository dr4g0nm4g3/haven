...
#ifndef _HCLIB_STRING_H
#define _HCLIB_STRING_H _HCLIB_STRING_H
...
*/
void * memcpy( void * _HCLIB_restrict s1, const void * _HCLIB_restrict s2, size_t n );

/* Copy a number of n characters from the memory area pointed to by s2 to the
   area pointed to by s1. The two areas may overlap.
   Returns the value of s1.
*/
void * memmove( void * _HCLIB_restrict s1, const void * _HCLIB_restrict s2, size_t n );

/* Copy the character array s2 (including terminating '\0' byte) into the
   character array s1.
   Returns the value of s1.
*/
char * strcpy( char * _HCLIB_restrict s1, const char * _HCLIB_restrict s2 );
...
/* Copy a maximum of n characters from the character array s2 into the character
   ...
   Returns the value of s1.
*/
char * strncpy( char * _HCLIB_restrict s1, const char * _HCLIB_restrict s2, size_t n );
...
/* Append the contents of the character array s2 (including terminating '\0') to
   ...
   Returns the value of s1.
*/
char * strcat( char * _HCLIB_restrict s1, const char * _HCLIB_restrict s2 );
...
/* Append a maximum of n characters from the character array s1 to the character
   ...
   Returns the value of s1.
*/
char * strncat( char * _HCLIB_restrict s1, const char * _HCLIB_restrict s2, size_t n );
...
/* Transform the character array s2 as appropriate for the LC_COLLATE setting of
   ...
   string.
*/
size_t strxfrm( char * _HCLIB_restrict s1, const char * _HCLIB_restrict s2, size_t n );
...
*/
char * strtok( char * _HCLIB_restrict s1, const char * _HCLIB_restrict s2 );
