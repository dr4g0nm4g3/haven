...
int vfprintf( struct _HCLIB_file_t * _HCLIB_restrict stream, const char * _HCLIB_restrict format, va_list arg )
{
    /* TODO: This function should interpret format as multibyte characters.  */
    /* Members: base, flags, n, i, this, s, width, prec, stream, arg         */
    struct _HCLIB_status_t status = { 0, 0, SIZE_MAX, 0, 0, NULL, 0, 0, stream, arg };
    while ( *format != '\0' )
    {
        const char * rc;
        if ( ( *format != '%' ) || ( ( rc = _HCLIB_print( format, &status ) ) == format ) )
        {
