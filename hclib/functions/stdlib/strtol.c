...
long int strtol( const char * s, char ** endptr, int base )
{
    ...
    if ( sign == '+' )
    {
        rc = _HCLIB_strtox_main( &p, (unsigned)base, (uintmax_t)LONG_MAX, (uintmax_t)( LONG_MAX / base ), (uintmax_t)( LONG_MAX % base ), &sign );
    }
    else
    {
        /* FIXME: This breaks on some machines that round negatives wrongly */
        rc = _HCLIB_strtox_main( &p, (unsigned)base, (uintmax_t)LONG_MIN, (uintmax_t)( LONG_MIN / -base ), (uintmax_t)( -( LONG_MIN % base ) ), &sign );
    }
